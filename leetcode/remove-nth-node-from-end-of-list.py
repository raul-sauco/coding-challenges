...
# node right after the slow pointer. This handles
# the case when n == 1.
...
#
# Runtime: 36 ms, faster than 89.47% of Python3 online submissions for
# Remove Nth Node From End of List.
# Memory Usage: 13.8 MB, less than 69.55% of Python3 online submissions
